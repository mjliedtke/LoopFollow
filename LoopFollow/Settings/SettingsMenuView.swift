...
enum SettingsRoute: Hashable, Identifiable {
    ...
    var leaves: [SettingsLeaf] {
        ...
        case .general: return [
                ...
                SettingsLeaf("Night Mode", ["dim", "brightness", "nightstand", "dark", "red"]),
                SettingsLeaf("Dim Screen", ["dim", "brightness"]),
                SettingsLeaf("Dim When Idle", ["idle", "dim", "inactivity"]),
                SettingsLeaf("Red Night Colors", ["red", "night vision", "palette"]),
